...
class LfcColors {
  ...
  static BrandPalette get lusailBrand => BrandPalette.lusail;
}
...
class LfcPalette extends ThemeExtension<LfcPalette> {
  ...
  static LfcPalette dark(BrandPalette brand) => LfcPalette(
    gold: brand.goldBright,
    goldBright: brand.goldBright,
    onHero: const Color(0xFFEAF2FA),
    onHeroMuted: const Color(0xFFB6CBE0),
    heroGradient: [brand.heroStart, brand.heroEnd],
    heroPattern: brand.goldBright.withValues(alpha: 0.14),
    success: brand.successBright,
    muted: LfcColors.darkTextMuted,
  );

  static LfcPalette light(BrandPalette brand) => LfcPalette(
    gold: brand.gold,
    goldBright: brand.goldBright,
    onHero: const Color(0xFFEAF2FA),
...
extension LfcPaletteContext on BuildContext {
  LfcPalette get lfc =>
      Theme.of(this).extension<LfcPalette>() ??
      LfcPalette.light(LfcColors.lusailBrand);
}

const _displayFont = 'Changa';
const _bodyFont = 'Tajawal';

ThemeData buildLightTheme([BrandPalette brand = BrandPalette.lusail]) =>
    _buildTheme(_lightScheme(brand), LfcPalette.light(brand));

ThemeData buildDarkTheme([BrandPalette brand = BrandPalette.lusail]) =>
    _buildTheme(_darkScheme(brand), LfcPalette.dark(brand));

ColorScheme _lightScheme(BrandPalette brand) => ColorScheme(
  brightness: Brightness.light,
  primary: brand.primary,
  onPrimary: Colors.white,
  primaryContainer: brand.primaryTint,
  ...
  inversePrimary: brand.primarySoft,
  shadow: Colors.black,
  scrim: Colors.black,
);
...
ColorScheme _darkScheme(BrandPalette brand) => ColorScheme(
  ...
  secondaryContainer: brand.goldDeep,
  onSecondaryContainer: Color(0xFFFFF2D6),
  tertiary: brand.goldBright,
