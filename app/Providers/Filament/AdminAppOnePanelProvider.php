...
class AdminAppOnePanelProvider extends PanelProvider
{
    ...
    public function panel(Panel $panel): Panel
    {
        ...
        return $panel
            // App one intentionally keeps the legacy discovery paths unchanged.
            ...
            ->middleware([
                ...
                StartSession::class,
                SetAppContext::class.':'.AppKey::AppOne->value,
